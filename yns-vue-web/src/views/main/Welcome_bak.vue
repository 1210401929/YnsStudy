<template>
  <div class="container" :class="currentTheme">
    ...
    <main class="main-content">
      <h1 class="brand toDefault">🌴 YnsStudy</h1>
      ...
      <div class="buttons">
        ...
        <el-button type="danger" @click="buttonClick('aboutWe')" size="large" round>关于</el-button>
      </div>
    </main>
    <!-- 泡泡背景 -->
    <div class="bubbles">
...
const seoTitle = ref('YnsStudy - 少一点迷茫，多一点引导');
const seoDescription = ref('YnsStudy：少一点迷茫，多一点引导，学习之路不再孤单。永远相信美好的事情即将发生。');
const seoKeywords = ref('YnsStudy, 学习引导, 内容社区, 技术博客, AI辅助学习,开发者社区,编程学习');
